...
- `pnpm bench:compare`（call-style）
  - Node: `48.194 - 53.685 ms`（平均 `50.359 ms`）
  - Python: `354.779 - 403.182 ms`（平均 `368.914 ms`）
  - Rust: `24.526 - 34.755 ms`（平均 `29.665 ms`）
- `pnpm bench:compare:replace`
  - Node: `18.529 - 21.801 ms`（平均 `21.059 ms`）
  - Python: `82.144 - 86.467 ms`（平均 `83.936 ms`）
  - Rust: `6.949 - 7.742 ms`（平均 `7.438 ms`）
- `pnpm bench:compare:sample:replace`
  - Node: `342.693 - 352.539 ms`（平均 `348.063 ms`）
  - Python: `1418.803 - 1436.763 ms`（平均 `1427.259 ms`）
  - Rust: `103.519 - 108.433 ms`（平均 `105.348 ms`）
